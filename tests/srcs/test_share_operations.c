...
/*   Updated: 2020/01/24 16:16:17 by mmarcell      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
Test(sh_operations_push, full_full)
{
	...
	cr_expect(dst->head->data == 2, "data of pushed element incorrect");
...
Test(sh_operations_push, one_two)
{
	...
	cr_expect(dst->head->data == 263, "dst data of pushed element incorrect");
	cr_expect(dst->head->next->data == 54, "dst data of pushed element incorrect");
	cr_expect(dst->head->next->next->data == 263, "dst data of pushed element incorrect");
	cr_expect(dst->head->prev->data == 54, "dst data of pushed element incorrect");
	cr_expect(dst->head->prev->prev->data == 263, "dst data of pushed element incorrect");
	cr_expect(src->head->data == -863, "src data of pushed element incorrect");
	cr_expect(src->head->prev->data == -863, "src data of pushed element incorrect");
	cr_expect(src->head->next->data == -863, "src data of pushed element incorrect");
	cr_expect(first_src == dst->head, "push dst linking incorrect");
	cr_expect(first_src == dst->head->prev->next, "push dst linking incorrect");
	cr_expect(first_src == dst->head->next->prev, "push dst linking incorrect");
	cr_expect(second_src == src->head, "push src linking incorrect");
...
Test(sh_operations_push, two_one)
{
	...
	cr_expect(first_src->data == dst->head->data, "dst data of pushed element incorrect");
	cr_expect(first_src == dst->head, "push dst linking incorrect");
	cr_expect(first_src == dst->head->prev->next, "push dst linking incorrect");
	cr_expect(first_src == dst->head->next->prev, "push dst linking incorrect");
