...
/*   Updated: 2020/01/14 17:10:03 by mmarcell      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
Test(sh_input_validation, multi_string_dup)
{
	...
	cr_assert(is_valid_input(5, &"08179" "0" "3792" "3792" "2289", &stack_a) == 1 , "multi string input containing duplicate arguments should be invalid.");
